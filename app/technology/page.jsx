    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className="fixed w-full z-50 bg-gray-800 shadow-lg">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex flex-wrap justify-end space-x-2 md:space-x-8 text-sm md:text-base">
            ...
            <a href="/technology" className="text-yellow-400 hover:text-yellow-400 font-medium transition-colors duration-300">Technology</a>
      ...
      <div className={`fixed top-0 left-0 h-full w-full bg-gray-800 z-40 transition-transform transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden`}>
        ...
        <div className="flex flex-col items-center space-y-8 text-lg font-medium py-10">
          ...
          <a href="/technology" onClick={() => setIsMenuOpen(false)} className="text-yellow-400 hover:text-yellow-400 transition-colors duration-300">Technology</a>
        ...
        <section className="py-16 md:py-24 bg-gray-900">
          <div className="container mx-auto px-6">
            <div className="text-center">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Innovative Solutions for a Digital World</h2>
              <p className="text-lg text-gray-300 max-w-4xl mx-auto">
                DLTSynergy's Technology division leverages cutting-edge tools and methodologies to deliver robust and scalable solutions. Our expertise spans software development, IT infrastructure, cybersecurity, and data analytics, helping businesses navigate the complexities of the modern tech landscape.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row items-center mb-20 md:space-x-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-300 text-lg mb-4">
                  We build tailor-made software solutions that perfectly align with your business goals. From enterprise applications to mobile apps, our team ensures every product is high-performing, secure, and user-friendly.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center mb-20 md:space-x-reverse md:space-x-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-300 text-lg mb-4">
                  We design, implement, and manage robust IT infrastructures, including cloud-based solutions. Our services ensure your systems are reliable, secure, and scalable to support your company's growth.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center mb-20 md:space-x-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-300 text-lg mb-4">
                  Protecting your digital assets is our priority. We provide comprehensive cybersecurity services to safeguard your data and systems. We also help you unlock the power of your data through advanced analytics and business intelligence.
                </p>
              </div>
            </div>
          </div>
